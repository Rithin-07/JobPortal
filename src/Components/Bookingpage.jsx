...
const tutors = [
    { id: 1, name: 'John', fee: '4000 rs/hr', image: 'https://pbs.twimg.com/media/EQ504kqWkAIAHaw.jpg:large', experience: '5 years', rating: '4.5/5', description: 'Expert in Java and Python' },
        ...
        <Container sx={{ mt: 12, mb: 8 }}>
            <Grid container spacing={4}>
                ...
                <Grid item xs={12} md={6}>
                    <Typography variant="h4" gutterBottom>Apply Jobs</Typography>
